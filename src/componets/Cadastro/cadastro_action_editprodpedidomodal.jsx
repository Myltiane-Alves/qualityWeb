...
export const CadastroActionEditProdPedidoModal = () => {
  return (
    ...
    <Fragment>
      ...
      <div className="form-group">
        <input type="hidden" name="idDetProdPedido" id="idDetProdPedido" value="" />
        <input type="hidden" name="idResProdPedido" id="idResProdPedido" value="" />
        <div className="row">
          ...
          <div className="col-sm-6 col-xl-2">
            <label className="form-label" htmlFor="prodcb">Cod. Barras</label>
            <div className="input-group">
              <input type="text" id="codbproduto" name="codbproduto" className="form-control" value="" readOnly />
            </div>
          </div>
      ...
      <div className="form-group">
        <div className="row">
          <div className="col-sm-6 col-xl-2">
            ...
            <div className="input-group">
              <select className="select form-control" name="tamprod" id="tamprod">
                <option value=""> </option>
