            ...
            <div className="row">
              <div className="col-sm-4 col-xl-4">
                ...
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"cnpjforn"}
                  value={dadosDetalheFornecedor[0]?.NUCNPJ}
                  readOnly={false}
                />
              </div>
              <div className="col-sm-4 col-xl-4">
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"inscestadualforn"}
                  value={dadosDetalheFornecedor[0]?.NUINSCESTADUAL}
                  readOnly={false}
                />
              </div>
              <div className="col-sm-4 col-xl-4">
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"inscmuniforn"}
                  value={dadosDetalheFornecedor[0]?.NUINSCMUNICIPAL}
                  readOnly={false}
                />
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-sm-6 col-xl-4">
                ...
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"razaoforn"}
                  value={dadosDetalheFornecedor[0]?.NORAZAOSOCIAL}
                  readOnly={false}
                />
              </div>
              <div className="col-sm-6 col-xl-4">
                ...
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"fantasiaforn"}
                  value={dadosDetalheFornecedor[0]?.NOFANTASIA}
                  readOnly={false}
                />
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-sm-3 col-xl-2">
                ...
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"cepforn"}
                  value={dadosDetalheFornecedor[0]?.NUCEP}
                  readOnly={false}
                />
              </div>
              <div className="col-sm-3 col-xl-5">
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"enderecoforn"}
                  value={dadosDetalheFornecedor[0]?.EENDERECO}
                  readOnly={false}
                />
              </div>
              <div className="col-sm-3 col-xl-2">
                ...
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"numeroendforn"}
                  value={dadosDetalheFornecedor[0]?.ENUMERO}
                  readOnly={false}
                />
              </div>
              <div className="col-sm-3 col-xl-3">
                <InputFieldModal
                  ...
                  value={dadosDetalheFornecedor[0]?.ECOMPLEMENTO}
                  readOnly={false}
                />
            ...
            <div className="row">
              <div className="col-sm-3 col-xl-4">
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"bairroforn"}
                  value={dadosDetalheFornecedor[0]?.EBAIRRO}
                  readOnly={false}
                />
              </div>
              <div className="col-sm-3 col-xl-4">
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"cidadeforn"}
                  value={dadosDetalheFornecedor[0]?.ECIDADE}
                  readOnly={false}
                />
              </div>
              <div className="col-sm-3 col-xl-2">
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"ufforn"}
                  value={dadosDetalheFornecedor[0]?.SGUF}
                  readOnly={false}
                />
              </div>
              <div className="col-sm-3 col-xl-2">
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"nibgeforn"}
                  value={dadosDetalheFornecedor[0]?.NUIBGE}
                  readOnly={false}
                />
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-sm-6 col-xl-6">
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"nomerepreforn"}
                  value={dadosDetalheFornecedor[0]?.NOREPRESENTANTE}
                  readOnly={false}
                />
              </div>
              <div className="col-sm-6 col-xl-6">
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"emailforn"}
                  value={dadosDetalheFornecedor[0]?.EEMAIL}
                  readOnly={false}
                />
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-sm-3 col-xl-3">
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"tel1forn"}
                  value={dadosDetalheFornecedor[0]?.NUTELEFONE1}
                  readOnly={false}
                />
              ...
              <div className="col-sm-3 col-xl-3">
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"tel2forn"}
                  value={dadosDetalheFornecedor[0]?.NUTELEFONE2}
                  readOnly={false}
                />
              </div>
              <div className="col-sm-3 col-xl-3">
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"tel3forn"}
                  value={dadosDetalheFornecedor[0]?.NUTELEFONE3}
                  readOnly={false}
                />
              </div>
              <div className="col-sm-3 col-xl-3">
            ...
            <div className="row">
              ...
              <div className="col-sm-4 col-xl-3">
                ...
                <InputFieldModal
                  ...
                  type={"text"}
                  id={"novendedor"}
                  value={dadosDetalheFornecedor[0]?.NOVENDEDORPADRAO}
                  readOnly={false}
                />
              </div>
