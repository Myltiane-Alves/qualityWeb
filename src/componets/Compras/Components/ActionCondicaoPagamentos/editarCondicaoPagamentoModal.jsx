...
export const ActionEditarCondicaoPagamentoModal = ({ show, handleClose, dadosDetalheCondPagamento }) => {
  ...
  const onSubmit = async () => {
    ...
    const response = await put('/atualizarCondicaoPagamento', postData)
      .then(response => {
  ...
  console.log(dadosDetalheCondPagamento, 'dadosDetalheCondPagamento')
  return (
              ...
              <div className="row">
                ...
                <div className="col-sm-6 col-lg-6">
                  ...
                  <InputFieldModal
                    ...
                    type={"text"}
                    id={"desccondpag"}
                    value={dadosDetalheCondPagamento[0]?.DSCONDICAOPAG}
                ...
                <div className="col-sm-6 col-lg-3">
                  ...
                  <InputFieldModal
                    ...
                    value={dadosDetalheCondPagamento[0]?.NUPARCELAS}
              ...
              <div className="row">
                <div className="col-sm-6 col-lg-3">
                  <InputFieldModal
                    ...
                    type={"number"}
                    id={"dia1condpag"}
                    value={dadosDetalheCondPagamento[0]?.NUNDIA1PAG}
                ...
                <div className="col-sm-6 col-lg-3">
                  ...
                  <InputFieldModal
                    ...
                    type={"number"}
                    id={"qtdcondpag"}
                    value={dadosDetalheCondPagamento[0]?.QTDDIAS}
            ...
            <div className="form-group">
              <div className="row">
                <div className="col-sm-6 col-lg-6">
                  ...
                  <Select
                    defaultValue={dadosDetalheCondPagamento[0]?.STATIVO || statusSelecionado}
                    options={options.map((item) => {
                      return {
                        value: item.value,
                        label: item.label
