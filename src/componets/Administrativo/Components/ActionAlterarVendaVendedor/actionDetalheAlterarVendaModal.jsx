...
export const ActionDetalheAlterarVendaModal = ({ show, handleClose, dadosVendasDetalhada, empresaSelecionada }) => {
  ...
  const getListaVendedor = async () => {
    try {
      const response = await get(`/funcionarioAtivoPorEmpresa?idEmpresa=${empresaSelecionada}`);
  ...
  const handleSelectAll = (isChecked) => {
    ...
    setSelectedIds(updatedSelectedIds)
    console.log(updatedSelectedIds, 'updatedSelectedIds')
  }
