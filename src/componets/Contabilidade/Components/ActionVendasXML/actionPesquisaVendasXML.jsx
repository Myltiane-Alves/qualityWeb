...
export const ActionPesquisaVendasXML = () => {
  ...
  // const [stContigencia] = useState('')
  // const [stCancelado] = useState('')
  ...
  return (
    ...
    <Fragment>
      ...
      <ActionMain
        ...
        valueSelectSituacao={console.log(statusSelecionado, 'status input')}
        ...
        onButtonClickCadastro={handleDownloadXML}
